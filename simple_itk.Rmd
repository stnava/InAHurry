...
identifying the state-of-the-art in MAL.  [@SATA]
...
**FIXME Nick** can you add citations to specific classes that exist as "beta" versions
which will be added to ITK, improved etc.
...
**FIXME** Nick add some stuff about yourself here
