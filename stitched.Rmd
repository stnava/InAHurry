...
\begin{center}
{\bf \Large
Simple ITK multi-atlas registration and segmentation:\\
...
at the University of Pennsylvania.  He has a Ph.D. in Biongineering
and Masters in Computer Science from the University of Pennsylvania with
expertise in the development of analysis stems for multidimensional
medical datasets that include imaging with a particular emphasis on
open-source dissemination.  He is the founder and lead
...
* James C. Gee (??, 0.24 c.m. effort) is an Associate Professor of Radiologic
...
* Paul Yushkevich (??, 0.24 c.m. effort) is an Associate Professor of Radiology at the
...
* Nicholas J. Tustison (consultant, ?? effort) is an Assistant Professor of Radiology
